...
void call(int n)
{
    ...
    do{
        ...
        if( INCLUDE3(i, x) ) continue;
        while( x /= 10, x )
            if( INCLUDE3(i, x) ) break;
    }while( ++i <= n );
